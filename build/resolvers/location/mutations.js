...
exports.LocationMutations = {
    createLocation: function (_root, args, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var input, manager, user, formatResponse, loc, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, manager.insert(Location_1.Location, loc)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        return [2 /*return*/, formatResponse(false, 'Could not save location, please, try again later!')];
                    case 4: return [2 /*return*/, formatResponse(true, 'Location successfully created!', loc)];
                }
            });
        });
    },
